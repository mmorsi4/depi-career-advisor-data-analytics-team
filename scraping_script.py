...
if __name__ == "__main__":
    # Test run
    df = scrape_linkedin_jobs("", "Egypt", target_jobs=20)         # write search in first argument, location in second , target_jobs third
    if df is not None and not df.empty:
        # Ensure columns are in the exact order specified with location as third column
        ...
        print("\nJobs saved to linkedin_jobs.csv")        # save to csv file
